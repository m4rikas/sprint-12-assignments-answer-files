...
function calcPageFillRadius(x, y) {
  var l = Math.max(x - 0, canvasW - x);
  var h = Math.max(y - 0, canvasH - y);
...
function handleEvent(e) {
    ...
    var currentColor = pickColor.current();
    var nextColor = pickColor.next();
    var targetR = calcPageFillRadius(e.pageX, e.pageY);
    var rippleSize = Math.min(200, (canvasW * .4));
